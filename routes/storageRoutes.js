...
router.get('/folders/all', auth, storageController.getAllFolders);
...
router.get('/view/:resourceId', auth, storageController.viewResource);
router.get('/metadata/:resourceId', auth, storageController.getResourceMetadata);

// Move operation
router.put('/move', auth, storageController.moveItem);
